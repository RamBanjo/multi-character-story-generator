...
go_to_alicehouse = StoryNode("go_to_alicehouse", None, None, {"Type": "movement"}, 1, effects_on_next_ws=[move_to_alicehouse, move_away], condition_tests=[double_edge_alicehouse])
