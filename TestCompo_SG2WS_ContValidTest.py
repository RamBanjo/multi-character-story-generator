...
grouping_split_tc6 = [{"actor_group":[alice], "target_group":[]}, {"actor_group":[bob, charlie, daniel], "target_group":[]}]
validity = test_sg.check_joint_continuity_validity(joint_rule=if_x_then_split_into_wz_split, main_character=alice, grouping_split=grouping_split_tc6, insert_index=1, verbose=True)
