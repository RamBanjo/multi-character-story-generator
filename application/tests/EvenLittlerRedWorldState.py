...
# Rule: Patternless -> Brawl for Rod
patternless_into_brawl_for_rod = JoiningJointRule(base_actions=[], joint_node=brawl_for_rod, rule_name="Patternless Into Brawl for Rod")
list_of_rules.append(patternless_into_brawl_for_rod)

# Rule: Brawl for Rod into Defeat and Take Rod
brawl_rod_into_defeat_take = ContinuousJointRule(base_joint=brawl_for_rod, joint_node=defeat_and_take_rod_target_unconscious, rule_name="Brawl for Rod into Defeat and take Rod")
list_of_rules.append(brawl_rod_into_defeat_take)
...
# current_location_has_someone_actor_fears_penalty = SomethingPassesAllGivenTestsTest(list_of_tests_with_placeholder=[current_location_holds_someone, actor_fears_someone], score=-10)
...
# target_location_has_someone_actor_fears_reward = SomethingPassesAllGivenTestsTest(list_of_tests_with_placeholder=[target_holds_someone, actor_fears_someone], score=10)
...
# movement_requirement = [actor_is_alive, actor_is_not_unconscious, actor_is_held_by_location_check]
...
# Just as I suspected, the characters are able to complete the quest at the same time and they all end up holding the same object if they are all doing it in the same timestep. How do I fix this?