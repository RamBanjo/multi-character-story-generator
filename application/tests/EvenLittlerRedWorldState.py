...
report_scared_forest = StoryNode(name="Report Scared Forest Village", tags={"Type":"GiveTask"}, charcount=1, target_count=1, effects_on_next_ws=all_destroyhouse_taskchanges, required_test_list=[actor_is_alive, target_is_alive, actor_has_scared_witch_check, actor_has_scared_bear_check, actor_has_scared_brick_check, actor_has_no_reportscare_memory_check])
