...
kill_another_actor = StoryNode(name="Actor Kills Actor", tags={"Type":"Murder"}, charcount=1, target_count=1, effects_on_next_ws=[target_becomes_dead, actor_gains_kill_relationship], required_test_list=[target_is_alive, actor_has_reason_to_kill_target, target_no_plot_armor])
...
recall_tasks = StoryNode(name="Iris Remembers Tasks", effects_on_next_ws=[notice_invader_taskchange, get_attack_tatain_taskchange, get_attacked_by_robots_taskchange], charcount=1, target_count=1)
# Invade Greenland
# Source: Alien God
# Owner: Apollo
...
story_graph.insert_story_part(part=get_command_from_higher_up, character=amil, location=new_world_greenland, absolute_step=0, timestep=0)
