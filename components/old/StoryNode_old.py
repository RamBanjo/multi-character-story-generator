...
class StoryNode:
    ...
    def add_next_node(self, next_node, character_reference):
        self.next_nodes[character_reference.get_name()] = next_node
        next_node.previous_nodes[character_reference.get_name()] = self
    ...
    def remove_next_node(self, character_reference):
        next_node = self.next_nodes[character_reference.get_name()]

        del next_node.previous_nodes[character_reference.get_name()]
        del self.next_nodes[character_reference.get_name()]
